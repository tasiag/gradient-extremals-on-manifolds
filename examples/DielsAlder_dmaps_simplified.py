...
from DataSampleSimplified import DataSample, get_collective_variables
...
name = ("0", "unbiased") #"STC_US_2.7_3.0"# "2.5_5.5-2.5_5.5" #"US_4_4" "4.5_7.5-4.5_7.5"
...
np.savetxt("ForBryan/dmaps.npy", dmaps, delimiter=",")

# plot mesh for checking V
fig, (ax1, ax2) = plt.subplots(1, 2)
a = ax1.scatter(data_sample.colvars_reduced[:,0], data_sample.colvars_reduced[:,1], s=0.5)
ax1.set_title("Collective Variable Space")
ax1.set_aspect("equal")
ax1.set_xlabel("C1")
ax1.set_ylabel("C2")
a = ax2.scatter(dmaps[:,0], dmaps[:,1], s=0.5)
ax2.set_aspect("equal")
ax2.set_title("Diffusion Coordinate Space")
ax2.set_xlabel("d1")
ax2.set_ylabel("d2")
plt.tight_layout()
plt.show()
